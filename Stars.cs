...
namespace Lab3Invaders
{
    class Stars
    {
        // each star has a location as well as a color
        private struct Star
        {
            public Point point;
            public Pen pen;
        ...
        // remove 5 stars from the screen at random, and add 5 more at random locations to simulate twinkling
        ...
        // choose random color for the stars
